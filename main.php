...
<body>
    ...
    <div class="slidewrap">
        <ul class="slidelist">
            ...
            <li class="slideitem">
                <a>
                    <img src="/assets/1-3.jpg" alt="Slide 1 Image" style="width: 80%; height: auto; margin-left: 10%">
                </a>
            </li>
            <li class="slideitem">
                <a>
                    <img src="/assets/2-1.jpg" alt="Slide 2 Image" style="width: 80%; height: auto; margin-left: 10%">
                </a>
            </li>
            <li class="slideitem">
                <a>
                    <img src="/assets/3-1.jpg" alt="Slide 3 Image" style="width: 80%; height: auto; margin-left: 10%">
                </a>
            </li>
            <li class="slideitem">
                <a>
                    <img src="/assets/4-1.jpg" alt="Slide 4 Image" style="width: 80%; height: auto; margin-left: 10%">
                </a>
            </li>
            <li class="slideitem">
                <a>
                    <img src="/assets/5-1.jpg" alt="Slide 5 Image" style="width: 80%; height: auto; margin-left: 10%">
                </a>
            </li>
            <li class="slideitem">
                <a>
                    <img src="/assets/6-1.jpg" alt="Slide 6 Image" style="width: 70%; height: auto; margin-left: 15%">
                </a>
            </li>
            <li class="slideitem">
                <a>
                    <img src="/assets/7-1.jpg" alt="Slide 7 Image" style="width: 70%; height: auto; margin-left: 15%">
                </a>
            </li>
            <li class="slideitem">
                <a>
                    <img src="/assets/8-1.jpg" alt="Slide 8 Image" style="width: 70%; height: auto; margin-left: 15%">
                </a>
            </li>
            <li class="slideitem">
                <a>
                    <img src="/assets/9-1.jpg" alt="Slide 9 Image" style="width: 65%; height: auto; margin-left: 15%">
                </a>
            </li>
							<!-- 좌,우 슬라이드 버튼 -->
