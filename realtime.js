...
function checkReservationInfo() {
    ...
    window.location.href = `reservate_details.php?selectedTime=${selectedTimeInfo}&currentDate=${currentDate}&selectedSeats=${selectedSeats}`;
}
